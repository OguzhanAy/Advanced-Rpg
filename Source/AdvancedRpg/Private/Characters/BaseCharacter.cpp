...
void ABaseCharacter::DirectionaHitReact(const FVector& ImpactPoint)
{
...
void ABaseCharacter::SpawnImpactSystem(const FVector& ImpactPoint)
{
	if (ImpactEffect)
	{
		FRotator Rotation;
...
void ABaseCharacter::GetHit_Implementation(const FVector& ImpactPoint, AActor* Hitter)
{
	if (IsAlive() && Hitter)
	{
		DirectionaHitReact(Hitter->GetActorLocation());
	}
	else Die();
